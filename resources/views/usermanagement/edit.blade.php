    ...
    <div class="flex justify-center items-center min-h-screen bg-gray-100 p-4">
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden w-full max-w-4xl">
            <div class="p-8 md:p-10">
                <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center md:text-left">Edit User</h2>

                <form method="POST" action="{{ route('usermanagement.update', $user->id) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <x-text-input id="firstname"
                                ...
                                type="text" name="firstname" :value="old('firstname', explode(' ', $user->name)[0])" required autofocus
                        ...
                        <div class="flex flex-col">
                            ...
                            <x-text-input id="middlename"
                                class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition-all duration-200 text-sm"
                                type="text" name="middlename" :value="old('middlename', $user->middlename ?? '')" autocomplete="additional-name"
                                placeholder="M" />
                        ...
                        <div class="flex flex-col">
                            ...
                            <x-text-input id="lastname"
                                class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition-all duration-200 text-sm"
                                type="text" name="lastname" :value="old('lastname', last(explode(' ', $user->name)))" required autocomplete="family-name"
                                placeholder="Doe" />
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="relative">
                                <select id="role" name="role" required
                                    ...
                                    <option value="Staff" {{ $user->role === 'Staff' ? 'selected' : '' }}>👤 Secretary
                                    </option>
                                </select>
